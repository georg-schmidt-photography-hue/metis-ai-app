export default function PostCard({ post, index, platform, hasGeneratedContent, isGenerating, onGenerate, onView }) {
  ...
  return (
    <div className="bg-[#FFFDF9] border border-[#E8E4DD] rounded-xl p-5 hover:border-[#C4BFB6] transition-colors flex flex-col">
      ...
      {/* Footer: View original + Action button */}
      <div className="border-t border-[#E8E4DD] pt-3 mt-auto">
        {post.url && (
          <a
            ...
            className="text-[10px] text-[#A39E93] hover:text-[#D97706] transition-colors mb-2 block"
          >
            View original
          </a>
        )}
